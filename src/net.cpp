...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Rsvcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nuru-s2.fritz.box", "dnsseed.nuru-s2.fritz.box"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"nuru-s2.fritz.box", "testnet-seed.nuru-s2.fritz.box"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Rsvcoin is probably already running."), addrBind.ToString().c_str());
        else
